...
from src.data.protenix_pipeline.constants import EvaluationChainInterface
from src.data.protenix_pipeline.constraint_featurizer import ConstraintFeatureGenerator
...
from src.data.protenix_pipeline.msa_featurizer import MSAFeaturizer
from src.data.protenix_pipeline.tokenizer import TokenArray
from src.data.protenix_pipeline.utils import (
    data_type_transform,
    get_antibody_clusters,
    make_dummy_feature,
)
from src.data.protenix_pipeline.cropping import CropData
from src.data.protenix_pipeline.file_io import read_indices_csv
from src.data.protenix_pipeline.logger import get_logger
...
class BaseSingleDataset(Dataset):
    ...
    def process_one(
        ...
        basic_info["atom_array"] = cropped_atom_array
