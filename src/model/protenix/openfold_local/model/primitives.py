...
if fastln_is_installed:
    from src.model.protenix.model.layer_norm.layer_norm import FusedLayerNorm
...
from src.model.protenix.openfold_local.utils.precision_utils import is_fp16_enabled
from src.model.protenix.openfold_local.utils.tensor_utils import (
    flatten_final_dims,
    permute_final_dims,
)
...
def _tri_attention(
    ...
    Args:
        ...
        biases:
            List of biases that broadcast to [*, H, Q, K]
    """
    from src.model.protenix.model.tri_attention import TriAttentionFunction
